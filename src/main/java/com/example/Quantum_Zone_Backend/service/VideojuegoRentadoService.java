...
public class VideojuegoRentadoService {
        ...
        @Autowired
	public VideojuegoRentadoService(VideojuegosRentadosRepository videojuegoRRepository ,VideojuegoRentadoService videojuegoRService, 
                VideoJuegoService videojuegoService, ClienteService clienteService) {
            
		this.videojuegoRRepository = videojuegoRRepository;
		this.videojuegoRService = videojuegoRService;
	...
	public List<VideojuegoRentado> findByFilters(String id, Cliente cliente, VideoJuego videojuego, LocalDate fechaDeRenta, LocalDate fechaDeDevolucion) {
